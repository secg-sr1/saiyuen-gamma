                  ...
                  />
  ...
  
                    {
                      chipClickVisualizationA && 
                        <CardMedia 
                        component="img"
                        src="https://github.com/secg-sr1/saiyuen-gamma/blob/main/public/brige-03-render-00.png?raw=true"
                        sx={{ height: 200 }}
                        />
                    }
...

                    {
                      chipClickVisualizationB && 
                        <CardMedia 
                        component="img"
                        src="https://github.com/secg-sr1/saiyuen-gamma/blob/main/public/brige-03-render-01.png?raw=true"
                        sx={{ height: 200 }}
                        />
                    }
  ...
  
                    {
                      chipClickInstructions && 
                        <CardMedia 
                        component="img"
                        src="https://github.com/secg-sr1/saiyuen-alpha/blob/main/public/bridge-02-00.png?raw=true"
                        sx={{ height: 200 }}
                        />
                    }
              ...
              <AccordionDetails>
                <Card sx={{borderRadius:5, boxShadow:5, backgroundColor:'transparent', border:'1px solid rgba(255, 255, 255, 0.2)'}}>
                  ...
                  />
                    <CardMedia 
                        component="video"
                        src="https://github.com/secg-sr1/saiyuen-gamma/raw/refs/heads/main/public/bridge-03-video.mp4"
                        // autoPlay
                        loop
                        muted
                        controls={true}
